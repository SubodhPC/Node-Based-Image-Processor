...
void BeginCanvasInteraction(ImNodesEditorContext& editor)
{
    ...
    const bool started_panning = GImNodes->RightMouseClicked;
...
void ClickInteractionUpdate(ImNodesEditorContext& editor)
{
    ...
    {
        const bool dragging = GImNodes->RightMouseDragging;
...
void EndNodeEditor()
{
    ...
    if (!IsMiniMapHovered())
    {
        ...
        else if (GImNodes->LeftMouseClicked && GImNodes->HoveredNodeIdx.HasValue())
        {
            ...
            GImNodes->LeftMouseClicked || GImNodes->RightMouseClicked || GImNodes->LeftMouseReleased ||
